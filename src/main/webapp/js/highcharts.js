...
(function() {
    ...
    function Nb(a, b) {
        var c = b || [[zb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [ib, [1, 2, 5, 10, 15, 30]], [Ua, [1, 2, 5, 10, 15, 30]], [Ja, [1, 2, 3, 4, 6, 8, 12]], [oa, [1, 2]], [Va, [1, 2]], [Ka, [1, 2, 3, 4, 6]], [ta, null]],
        d = c[c.length - 1],
        e = B[d[0]],
        f = d[1],
        g;
    ...
    function Ob(a, b, c, d) {
        ...
        b === B[ta] ? k = Ya(h + d * j, 0) : b === B[Ka] ? k = Ya(h, l + d * j) : !g && (b === B[oa] || b === B[Va]) ? k = Ya(h, l, m + d * j * (b === B[oa] ? 1 : 7)) : (k += b * j, b <= B[Ja] && k % B[oa] === i && (f[k] = oa)),
        d++;
        e.push(k);
        e.info = r(a, {
            higherRanks: f,
    ...
    M = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL: "../../js/modules/canvas-tools.js"
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 5,
    ...
    var qa = function(a) {
        var b = [],
        c;
        (function(a) { (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [w(c[1]), w(c[2]), w(c[3]), parseFloat(c[4], 10)] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) && (b = [w(c[1], 16), w(c[2], 16), w(c[3], 16), 1])
        })(a);
        return {
            get: function(c) {
    ...
    va.prototype = {
        ...
        attr: function(a, b) {
            ...
            c !== "d" && c !== "visibility" && (u = parseFloat(u));
                ...
                e || (e = C.createElementNS(pa, "title"), g.appendChild(e)),
                e.textContent = d;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (aa !== this.cTT) {
                        if (t(j)) a.isSVG ? (q = Ca ? "-ms-transform": tb ? "-webkit-transform": bb ? "MozTransform": Ib ? "-o-transform": "", k[q] = k.transform = "rotate(" + j + "deg)") : (p = j * ab, u = V(p), p = Y(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", u, ", M12=", -p, ", M21=", p, ", M22=", u, ", sizingMethod='auto expand')"].join("") : R),
                        H(b, k);
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG && (b = a.width, c = a.height, d)) a.width = L(c * Y(g)) + L(b * V(g)),
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) z(f, "height", y(z(f, "height") - h, 0)),
                    f.cutHeight = h;
    ...
    ra.prototype = {
            ...
            function(c, d) {
                ...
                function(c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        da ? m.dx = 3 : m.x = g;
                        if (!da) {
                            if (d) { ! Z && a.renderer.forExport && H(o, {
                                    display: "block"
                                });
                                q = K.getComputedStyle && w(K.getComputedStyle(k, null).getPropertyValue("line-height"));
                                if (!q || isNaN(q)) {
                                    var F;
                                    if (! (F = j)) if (! (F = k.offsetHeight)) l[d] = b.getBBox ? b.getBBox().height: a.renderer.fontMetrics(b.style.fontSize).h,
                                    F = s(l[d] - (l[d - 1] || 0)) || 18;
                                    q = F
                                }
                                z(o, "dy", q)
                        ...
                        b.appendChild(o);
                        da++;
                        if (i) for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), t = []; c.length || t.length;) delete a.bBox,
                        F = a.getBBox().width,
                        m = F > i,
                        !m || c.length === 1 ? (c = t, t = [], c.length && (o = C.createElementNS(pa, "tspan"), z(o, {
                            dy: j || 16,
                            x: g
                        }), n && z(o, "style", n), b.appendChild(o), F > i && (i = F))) : (o.removeChild(o.firstChild), t.unshift(c.pop())),
                        c.length && o.appendChild(C.createTextNode(c.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
        button: function(a, b, c, d, e, f, g) {
            ...
            p = g.style;
            delete g.style;
            I(h.element, "mouseenter",

            function() {
                h.attr(f).css(m)
            });
            I(h.element, "mouseleave",
            function() {
                j = [e, f, g][i];
                k = [l, m, p][i];
                h.attr(j).css(k)
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            g.text = function(a, b) {
                ...
                if (!o) c = h ? -yb: 0,
                p.box = o = d ? m.symbol(d, -D * aa, c, p.width, p.height) : m.rect( - D * aa, c, p.width, p.height, 0, fb["stroke-width"]),
                o.add(p);
                o.attr(A({
                    width: p.width,
                    height: p.height
    ...
    if (!Z && !U) {
        ja = {
            ...
            attr: function(a, b) {
                ...
                a[c] = b);
                if (la(a)) c = a,
                u = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
                    ...
                    m = !0;
                    else if (c === "width" || c === "height") d = y(0, d),
                    this[c] = d,
                    ...
                    this[c] = d,
                    Aa(d) && (d += "px");
                    else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] || Q(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid",
                    this.dashstyle = d,
                    m = !0;
            ...
            empty: function() {
                for (var a = this.element.childNodes, b = a.length, c; b--;) c = a[b],
        ...
        var ha = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    p = m.x2 || m[2] || 0,
                    m = m.y2 || m[3] || 0,
                    t = 'angle="' + (90 - J.atan((m - a) / (p - c)) * 180 / xa) + '"',
                    F();
                    else {
                        var j = m.r,
                        r = j * 2,
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c,
                    g = b + d,
                    h; ! t(e) || !e.r ? f = ra.prototype.symbols.square.apply(0, arguments) : (h = O(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                    return f
                }
            }
        };
    ...
    Pa.prototype = {
        ...
        render: function(a, b) {
            ...
            if (h && !isNaN(P)) h.xy = r = this.getLabelPosition(P, r, h, f, j, F, a, s),
            this.isFirst && !o(d.showFirstLabel, 1) || this.isLast && !o(d.showLastLabel, 1) ? v = !1 : !y && f && j.overflow === "justify" && !this.handleOverflow(a, r) && (v = !1),
            s && a % s && (v = !1),
            v ? (h[this.isNew ? "attr": "animate"](r), h.show(), this.isNew = !1) : h.hide()
        },
        destroy: function() {
            Ea(this, this.axis)
        }
    ...
    ob.prototype = {
        ...
        getSeriesExtremes: function() {
            ...
            function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (h = g.xData, h.length) a.dataMin = O(o(a.dataMin, h[0]), Ma(h)),
                        ...
                        u = g.processedYData;
                        s = u.length;
                        for (f = 0; f < s; f++) if (n = h[f], q = u[f], i && (w = (F = q < D) ? k: j, P = F ? p: l, q = w[n] = t(w[n]) ? ea(w[n] + q) : q, c[P] || (c[P] = {}), c[P][n] || (c[P][n] = new Hb(a, a.options.stackLabels, F, n, m, i)), c[P][n].setTotal(q)), q !== null && q !== x && (C && (q = g.modifyValue(q)), A || (h[f + 1] || n) >= z.min && (h[f - 1] || n) <= z.max)) if (n = q.length) for (; n--;) q[n] !== null && (r[v++] = q[n]);
                        else r[v++] = q;
                        if (!a.usePercentage && r.length) a.dataMin = O(o(a.dataMin, r[0]), Ma(r)),
        ...
        adjustForMinRange: function() {
            ...
            f, g, h, i, j;
            if (this.isXAxis && this.minRange === x && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null: (n(this.series,
            function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function() {
            ...
            function(a) {
                ...
                b = y(b, f);
                d = y(d, g ? 0 : f / 2);
                e = y(e, g === "on" ? 0 : f); ! a.noSharedTooltip && t(k) && (c = t(c) ? O(c, k) : k)
            }),
        ...
        setTickPositions: function(a) {
            ...
            if (e) ! a && O(b.min, o(b.dataMin, b.min)) <= 0 && $a(10, 1),
            b.min = ea(ma(b.min)),
            b.max = ea(ma(b.max));
        ...
        render: function() {
            ...
            if (h && r) h[h.isNew ? "attr": "animate"](a.getTitlePosition()),
            h.isNew = !1;
            if (m && m.enabled) {
    ...
    pb.prototype = {
        ...
        move: function(a, b, c, d) {
            ...
            e.label.attr(f);
            if (g && (L(a - f.x) > 1 || L(b - f.y) > 1)) clearTimeout(this.tooltipTimeout),
    ...
    qb.prototype = {
        ...
        onmousemove: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                b._dist = L(k - b[c[i].xAxis.tooltipPosName || "plotX"]),
                j = O(j, b._dist),
                e.push(b);
        ...
        setDOMEvents: function() {
            ...
            d.onmousedown = function(d) {
                d = b.normalizeMouseEvent(d); ! fa && d.preventDefault && d.preventDefault();
                c.mouseIsDown = !0;
                c.cancelClick = !1;
    ...
    rb.prototype = {
        ...
        renderItem: function(a) {
            ...
            d = q.getBBox();
            u = a.legendItemWidth = e.itemWidth || g + h + d.width + k + (s ? 20 : 0),
            e = u;
            b.itemHeight = g = d.height;
            if (f && b.itemX - n + e > (m || c.chartWidth - 2 * k - n)) b.itemX = n,
    ...
    sb.prototype = {
        ...
        firstRender: function() {
            ...
            b.global.canvasToolsURL) : C.attachEvent("onreadystatechange",
            function() {
    ...
    N.prototype = {
        ...
        setData: function(a, b) {
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                if (Aa(g)) {
                    ...
                    j += d;
                    this.xIncrement = j
                } else if (Ha(g)) if (m) for (i = 0; i < l; i++) d = a[i],
                e[i] = d[0],
                k[i] = d.slice(1, m + 1);
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            j ? l[m] = (new f).init(this, [d[m]].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
        ...
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                if (c && this.visible && q && q[p]) r = q[p],
                p = r.total,
                r.cum = r = r.cum - n,
                n = r + n,
                j && (r = o(b.threshold, f.min)),
                f.isLog && r <= 0 && (r = null),
                c === "percent" && (r = p ? r * 100 / p: 0, n = p ? n * 100 / p: 0),
        ...
        drawPoints: function() {
            ...
            a = l.enabled && i.enabled === x || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e)) if (a = g.pointAttr[g.selected ? "select": ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
        ...
        drawDataLabels: function() {
            ...
            g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible": "hidden", 6),
            e = b,
            n(c,
            function(c) {
                var i, j = c.dataLabel,
    ...
    ha = ca(N, {
        ...
        drawPoints: function() {
            ...
            function(e) {
                var f = e.plotY,
                g = e.graphic;
                if (f !== x && !isNaN(f) && e.y !== null) d = e.shapeArgs,
                g ? (eb(g), g.animate(A(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select": ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
    ...
    W.scatter = A(ga, {
        ...
        tooltip: {
            headerFormat: '<span style="font-size: 12px; color:{series.color}">{series.name}</span><br/>',
                ...
                for (a = r[0][0] && r[0][0].dataLabel && (r[0][0].dataLabel.getBBox().height || 21); y--;) {
                    ...
                    if (j > 0) {
                        ...
                        for (v = 0; v < C; v++) {
                            ...
                            h = b.labelPos;
                            b = 9999;
                            for (q = 0; q < t; q++) g = L(x[q] - h[1]),
                            g < b && (b = g, B = q);
                            if (B < v && x[v] !== null) B = v;
                            else for (t < C - v + B && x[v] !== null && (B = t - C + v); x[B] === null;) B++;
                            A.push({
                                i: B,
                                y: x[B]
                            });
