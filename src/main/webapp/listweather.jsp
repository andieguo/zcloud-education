		...
		<div class="fns">
			...
			<form action="" method="get">
				<div class="module-history-list">
					<span class="history-list-dir">气象数据分析系统 > 气象数据列表</span>
				...
				<div class="list-view-header">
					<ul class="list-cols">
						<li class="col first-col" style="width: 60%;">
							...
							<a class="g-button" onClick="drawWeatherTable.downloadAllAction()">
								<span class="g-button-right">
									<em class="icon icon-download-gray" title="下载"></em>
									<span class="text">下载</span>
								</span>
							</a>
							<a class="g-button" onClick="drawWeatherTable.deleteAllAction()">
								<span class="g-button-right">
