...
<div class="aside main" style="width: 210px; float:left;">
	<div style="height: 533px;" class="b-view genere jfk-scrollbar" id="genere">
		<div class="minheight-forfooter">
			...
			<li class="b-list-item"><a  href="listexpress.jsp" class="on"><span class="text1"><span class="img-ico aside-moth"></span>快递文件列表</span></a></li>
			<li class="b-list-item"><a href="uploadexpress.jsp"><span class="text1"><span class="img-ico aside-mapp"></span>快递文件上传</span></a></li>
			<li class="b-list-item"><a href="uploadexpress.jsp"><span class="text1"><span class="img-ico aside-mapp"></span>快递信息上传</span></a></li>
