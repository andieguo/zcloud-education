						...
						<li class="col first-col" style="width: 60%;">
							...
							<a class="g-button" href="#">
								<span class="g-button-right">
									<em class="icon icon-download-gray" title="下载" onClick="drawExpressTable.downloadAllAction()"></em>
									<span class="text">下载</span>
								</span>
							</a>
							<a class="g-button" href="#">
								<span class="g-button-right">
									<em class="icon icon-delete" title="删除" onClick="drawExpressTable.deleteAllAction()"></em>
