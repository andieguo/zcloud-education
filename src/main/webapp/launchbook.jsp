...
$(function(){
	...
	%>
	getRuningJob('<%=url%>','Indexing Book Data');
	getOtherJob('<%=url%>','Indexing Book Data');
});
	...
	<div id="Container" style="float:left;width: 100%; height: 100%;min-width:790px;">
		<div class="fns">
			<div id="header-shaw" class="launchweather">
				<div class="title">
					<span class="title-left">图书馆图书管理系统  > 书籍索引构建</span>
					<span class="title-right">
					<form action="launchindex" method="get">
						点击启动快件分析作业：
