	...
	<div class="aside main" style="width: 210px; float:left;">
		<div style="height: 533px;" class="b-view genere jfk-scrollbar" id="genere">
			<div class="minheight-forfooter">
				...
				<li class="b-list-item"><a href="uploadbooks.jsp" class="sprite2 b-no-ln" hidefocus="true"><span class="text1"><span class="img-ico aside-mapp"></span>书籍上传和索引</span></a></li>
				<li class="b-list-item"><a  href="downloadbooks.jsp" class="sprite2 on" hidefocus="true"><span class="text1"><span class="img-ico aside-moth"></span>书籍下载</span></a></li>
