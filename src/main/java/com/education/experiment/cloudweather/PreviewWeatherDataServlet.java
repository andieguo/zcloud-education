...
public class PreviewWeatherDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static String slaveone = null;
	private static int fileCount = 0;

	public PreviewWeatherDataServlet() {
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ub != null) {
			...
			if (sign.equals("0")) {
				String result = getHadoopContent("/tomcat/experiment/weathercloud/uploaddata");
				if (result.equals("")) {
